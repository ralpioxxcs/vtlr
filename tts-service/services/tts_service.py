...
def generate_tts(voice: str, text: str):
  ...
  tts_modified_filepath = os.path.join(os.path.dirname(tts_original_filepath), 'tts_output_modified.wav')
  deep_smooth_voice(tts_original_filepath, tts_modified_filepath)
